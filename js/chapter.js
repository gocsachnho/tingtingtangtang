  ...
  content.innerHTML = `
    <section class="paywall-box">
      ...
      <div class="unlock-guide">
        <div class="unlock-guide-title">Hướng dẫn mở khóa</div>
        <div class="unlock-guide-steps">
          <div class="unlock-guide-step">
            <span>1</span>
            <b>Tạo mã thanh toán</b>
          </div>
          <div class="unlock-guide-step">
            <span>2</span>
            <b>Chuyển khoản đúng số tiền &amp; nội dung</b>
          </div>
          <div class="unlock-guide-step">
            <span>3</span>
            <b>Được xác nhận → nhập mã và mở khóa</b>
          </div>
        </div>
      </div>
